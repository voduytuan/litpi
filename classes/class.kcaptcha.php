...
class KCAPTCHA{
	...
	function KCAPTCHA(){
		...
		$allowed_symbols = "2345678abcdekmpsuvxyz"; #alphabet without similar symbols (o=0, 1=l, i=j, t=f)
		...
		$credits = 'Litpi.com'; # if empty, HTTP_HOST will be shown

		# CAPTCHA image colors (RGB, 0-255)
		//$foreground_color = array(0, 0, 0);
		//$background_color = array(220, 230, 255);
		//$foreground_color = array(mt_rand(0,100), mt_rand(0,100), mt_rand(0,100));
		$foreground_color = array(166, 72, 132);
		//$background_color = array(mt_rand(200,255), mt_rand(200,255), mt_rand(200,255));
		$background_color = array(255, 216, 241);
