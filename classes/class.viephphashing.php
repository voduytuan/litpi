<?php
/**
 * File dung de process password hashing
...
Class viephpHashing
{
	public static $secretString = 'thisstringisthebegginingofthelitpiframeworkpleasechangethisstring';	//never change this string, if not, all account will invalid.	
	public static $salt = '034898skdfjsde23098420sldkf';	//if change this value, user password cookie will invalid.
